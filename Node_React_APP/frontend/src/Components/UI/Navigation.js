...
const Navigation = () => {
  ...
  return (
    ...
    <Navbar fixed="bottom" style={{"margin-top":"30px",height:"12%",background:"white"}}>
      <Container>
        <Navbar.Brand style={{color:"black",fontWeight:"bolder"}} href="/central-report">{<img src={logo} style={{width:"450px",height:"auto"}} alt="Logo" />} Operational Network Overview</Navbar.Brand>
        <Navbar.Toggle aria-controls="responsive-navbar-nav" expand="lg"/>
        <Nav className="me-auto" >
            <Nav.Link   activeClassName="active"  href="/central-report">Central Report</Nav.Link>
